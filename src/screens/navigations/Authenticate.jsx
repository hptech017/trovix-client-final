...
import UserTopUp from "../admin/UserTopUp";
import UserTopUpHistory from "../admin/UserTopUpHistory";
                ...
                {role === "Admin" ? (
                    <>
                     ...
                     ˀ
                        ...
                        <Route
                            path={
                                AuthenticatedRoutes.ADMIN_USER_TOPUP
                            }
                            element={
                                <DashboardMain
                                    inner={<UserTopUp />}
                        ...
                        <Route
                            path={
                                AuthenticatedRoutes.ADMIN_USER_TOPUP_HISTORY
                            }
                            element={
                                <DashboardMain
                                    inner={<UserTopUpHistory />}
                                    name="User Top-Up History"
                                />
                            }
                        />
                        <Route
